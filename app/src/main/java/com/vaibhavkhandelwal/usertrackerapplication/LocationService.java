...
public class LocationService extends Service {
    ...
    public void saveLocation(){
        ...
        try {
            fos = openFileOutput("UserLocation.txt", MODE_PRIVATE);
            fos.write(LocationService.locationArrayList.toString().getBytes());

            Toast.makeText(this, "Saved to " + getFilesDir() + "/UserLocation.txt",
